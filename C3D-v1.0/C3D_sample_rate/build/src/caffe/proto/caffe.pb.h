...
enum LayerParameter_LayerType {
  ...
  LayerParameter_LayerType_SMOOTH_L1_LOSS = 34
};
...
const LayerParameter_LayerType LayerParameter_LayerType_LayerType_MAX = LayerParameter_LayerType_SMOOTH_L1_LOSS;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  static const LayerType SMOOTH_L1_LOSS = LayerParameter_LayerType_SMOOTH_L1_LOSS;
